          ...
          <ul className="flex flex-wrap items-center justify-center gap-2">
            {nav.map((item) => (
              <li key={item.href}>
                <Link
                  href={item.href}
                  className="inline-flex h-11 items-center rounded-full border border-rule px-5 text-[13px] font-semibold uppercase tracking-[0.08em] text-card-heading transition-colors hover:bg-brown hover:text-white"
                >
                  {item.label}
                </Link>
              </li>
