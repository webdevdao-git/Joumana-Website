...
function XMark() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" className="h-[52%] w-[52%]">
...
/** The design's order, which is not the order they sit in `site.socials`. */
const ORDER = ["Instagram", "Facebook", "X", "LinkedIn"] as const;
